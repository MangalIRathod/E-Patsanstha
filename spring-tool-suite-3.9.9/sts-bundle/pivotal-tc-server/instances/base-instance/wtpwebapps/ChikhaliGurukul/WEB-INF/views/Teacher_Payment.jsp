                    ...
                    <!-- Icon Cards-->
                        ...
                        <div class="card-body" align="center">
                            ...
                            <form  action="#" autocomplete="on" method="post">
                               ...
                               <div class="form-group row" align="center">
                                    <label for="example-text-input" class="col-4 col-form-label">Month</label>
                                    <div class="col-4">
                                        <input class="form-control" type="text" id="text2" name="text2" >
                                    </div>
                                </div>
                                <div class="form-group row" align="center">
                                    <label for="example-text-input" class="col-4 col-form-label">Latemark</label>
                                    <div class="col-4">
                                        <input class="form-control" type="text" id="text3" name="text3" >
                                    </div>
                                </div>
                                <div class="form-group row" align="center">
                                    <label for="example-text-input" class="col-4 col-form-label">MonthPayment</label>
                                    <div class="col-4">
                                        <input class="form-control" type="text" id="text4" name="text4" >
                                    </div>
                                </div>
                                <div class="form-group row" align="center">
                                    <label for="example-text-input" class="col-4 col-form-label">PayblePayment</label>
                                    <div class="col-4">
                                        <input class="form-control" type="text" id="text5" name="text5" >
                                    </div>
                                </div>
                             </form>
