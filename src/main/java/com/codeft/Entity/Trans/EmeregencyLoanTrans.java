...
@Entity
@Table(name="emergency_loan_trans")
public class EmeregencyLoanTrans {
	...
	public String getGuranteername2() {
		return guranteername2;
	}

	public void setGuranteername2(String guranteername2) {
		this.guranteername2 = guranteername2;
	}
