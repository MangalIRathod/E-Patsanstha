                        ...
                        <div class="card-body" align="center">
                            ...
                            <form  action="#" autocomplete="on" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control" type="date" id="edate" name="edate" min='1899-01-01' max='2000-13-13' required="required">
                                    </div>
                                </div>
								...
								<button type="button" class="btn btn-primary" onclick="return annual_report();">Report</button>
                            </form>
        	 	...
        	 	$.ajax({
        			...
        			timeout : 600000,
        	 		...
        	 		success : function(data) {
        	 			...
        	 			var res = data;
        	 			if (res == "Success") {
        	 				window.open('./user_annual_report_print', '_blank');        	 		
        	 			} else {
        	 				alert("user_annual_report_print Failed");        	 				
        	 			} 
        	 		}
        	 	});               	
                }          
