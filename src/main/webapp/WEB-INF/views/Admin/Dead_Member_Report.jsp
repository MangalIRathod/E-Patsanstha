                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body" align="center">
                            ...
                            <form  action="#" autocomplete="on" method="post" enctype="multipart/form-data">
								...
								<button type="button" class="btn btn-primary" onclick="return dead_member_report();">Report</button>
                            </form>
        	 	...
        	 	$.ajax({
        			...
        			timeout : 600000,
        	 		...
        	 		success : function(data) {
        	 			...
        	 			var res = data;
        	 			if (res == "Success") {
        	 				window.open('./Dead_Member_Report_Print', '_blank');
        	 		//	alert("Loan Apply Successfully");
        	 			} else {
        	 				alert("Dead_Member_Report_Print Failed");        	 				
        	 			} 
        	 		}
        	 	});               	
                }          
