...
<html lang="en">
    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <%@ include
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <i class="fa fa-table"></i> Emergency Loan Report</div>
                        <div class="card-body" align="center">
                            ...
                            <form  action="#" autocomplete="on" method="post" enctype="multipart/form-data">
								...
								<button type="button" class="btn btn-primary" onclick="return emergency_loan_report();">Report</button>
                            </form>
            ...
            function emergency_loan_report() {
        	 	...
        	 	$.ajax({
        			...
        			timeout : 600000,
        	 		...
        	 		success : function(data) {
        	 			...
        	 			var res = data;
        	 			if (res == "Success") {
        	 				window.open('./Emergency_Loan_Report_Print', '_blank');
        	 		//	alert("Loan Apply Successfully");
        	 			} else {
        	 				alert("Loan_Report_Print Failed");        	 				
        	 			} 
        	 		}
        	 	});               	
                }          
