...
<head>
<title>E-Patsanstha - Emergency Loan Close Report Print</title>
<style>
table {
...
<h3> Emergency Loan Close Report :  ${emergency_loan_close_date} </h3>
					...
					<table id="vaibhav">
					  ...
					  <tbody>
                        ...
                        <c:forEach var="obj" items="${emergency_loan_close_details}" varStatus="theCount">                       
                          <tr>                          		
                        		...
                        		<td><fmt:formatNumber type = "number" maxFractionDigits = "2" value = "${obj.interestamount}" /></td> 
