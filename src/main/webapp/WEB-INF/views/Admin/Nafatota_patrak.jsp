                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <i class="fa fa-table"></i> नफा तोटा पत्रक </div>
                        <div class="card-body" align="center">
                            ...
                            <form  action="#" autocomplete="on" method="post" enctype="multipart/form-data">
								...
								<button type="button" class="btn btn-primary" onclick="return balancesheet_report();">Report</button>
                            </form>
        	 	...
        	 	$.ajax({
        			...
        			timeout : 600000,
        	 		...
        	 		success : function(data) {
        	 			...
        	 			var res = data;
        	 			if (res == "Success") {
        	 				window.open('./Nafatota_patrak_print', '_blank');
        	 		//	alert("Loan Apply Successfully");
        	 			} else {
        	 				alert("Nafatota_patrak_print Failed");        	 				
        	 			} 
        	 		}
        	 	});               	
                }          
