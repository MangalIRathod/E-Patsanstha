                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <i class="fa fa-table"></i> Dead Member Report</div>
                        <div class="card-body" align="center">
                            ...
                            <form  action="#" autocomplete="on" method="post" enctype="multipart/form-data">
								...
								<button type="button" class="btn btn-primary" onclick="return cancel_member_report();">Report</button>
                            </form>
        	 	...
        	 	$.ajax({
        			...
        			timeout : 600000,
        	 		...
        	 		success : function(data) {
        	 			...
        	 			var res = data;
        	 			if (res == "Success") {
        	 				window.open('./Cancel_Member_Report_Print', '_blank');
        	 		//	alert("Loan Apply Successfully");
        	 			} else {
        	 				alert("Cancel_Member_Report_Print Failed");        	 				
        	 			} 
        	 		}
        	 	});               	
                }          
