        ...
        <%@ include
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <i class="fa fa-table"></i> Deduction Compare</div>
                        <div class="card-body" align="center">

                            <form  action="#" autocomplete="on" method="post" enctype="multipart/form-data">                               
                                
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-4 col-form-label">Patsanstha Deduction</label>
                                    <div class="col-8">
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-4 col-form-label">Bank Deduction</label>
                                    <div class="col-8">
                                        <input class="form-control" type="file" id="photo2" name="photo2" accept=".xlsx" />
                                    </div>
                                </div>
            ...
            function compare_report() {            
                ...
                var formData = new FormData();
                   ...
                   var file_data1 = $('input[type="file"]')[1].files;
                  for(var i = 0;i<file_data.length;i++){
                    formData.append("files0", file_data[i]);  
                    formData.append("files1", file_data1[i]);  
                    //alert(file_data[i]);
                   }
                   
                $.ajax({
                type : "POST",
                url : "../Admin/deduction_file",
