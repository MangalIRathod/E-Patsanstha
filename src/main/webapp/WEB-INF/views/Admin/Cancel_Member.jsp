...
<html lang="en">
    ...
    <head>
        ...
        <title>E-Sanstha Admin - Cancel Member</title>
        <!-- Bootstrap core CSS-->
...
function sum1() {
 ...
 //       
  ...
  //  }
    ...
    function sum3() {
        var insurance = document.getElementById('insurance').value; 
        var result = parseFloat(insurance) * 10 / 100;
          if (!isNaN(result)) {
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <i class="fa fa-table"></i> सभासदत्व रद्द झालेल्या सभासदांचा गोषवारा</div>
                        <div class="card-body" align="center">
                            ...
                            <form  action="#" autocomplete="on" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-4">
                                        <button type="button" class="btn btn-primary" onclick="return search_cancel_members();">Search</button>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-4 col-form-label">दिनांक</label>
                                    <div class="col-8">
                                        <input class="form-control" type="date" id="date" name="date" placeholder="दिनांक"  required="required">
                                    </div>
                                </div>
                                
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-4 col-form-label">कारण </label>
                                    <div class="col-8">
                                        <input class="form-control" type="text" id="reason" name="reason" placeholder="कारण"  required="required">
                                    </div>                                    
                                </div>
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-4 col-form-label">10 % Added Amount</label>
                                    <div class="col-4">
                                ...
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-4 col-form-label">Pay Account Name </label>
                                    <div class="col-8">
                                        <input class="form-control" type="text" id="payaccountname" name="payaccountname" placeholder="Pay Account Name"  required="required">
                                    </div>                                   
                                </div>
								<!--  
                                <div class="form-group row">
		                           <label for="example-text-input" class="col-4 col-form-label"></label> 	                           	                           
			                        <div class="col-4">
			                            <button type="button" class="btn btn-primary btn-block" onclick="return cancel_member_save();">Submit</button>
			                        </div>			                            
			                        <div class="col-4">
			                            <button type="button" class="btn btn-primary btn-block" onclick="return cancel_member_update();">Edit</button>
			                        </div>		                            
		                        </div>
		                        -->
		                        
		                        <button type="button" class="btn btn-primary " onclick="return cancel_member_save();">Submit</button>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-header">
                            <i class="fa fa-table"></i> सभासदत्व रद्द झालेल्या सभासदांचा गोषवारा &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <table class="table table-bordered table-responsive" id="dataTable" width="100%" cellspacing="0">          
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Pay Account Name</th>
                                </tr>
                            </thead>
							<tbody>
                        <c:forEach var="obj" items="${AllCancelMember}" varStatus="theCount">
                          <tr>
         ...
         <script>
            ...
            function cancel_member_save() {
        	    ...
        	    //var chequedate = changeDateFormat(inputDate2);
        	 	var payaccountname = document.getElementById("payaccountname").value;
        	 	...
        	 	//end
        	 	 ...
        	 	 var formData = new FormData();
        		    ...
        		    formData.append('payaccountname', payaccountname);  
        		    
        	 	$.ajax({
        	 		type : "POST",
        			url : "./cancel_member_save",
        			...
        			//contentType : "application/x-www-form-urlencoded; charset=UTF-8",
        	 		...
        	 		success : function(data) {
        	 			...
        	 			var res = data;
        	 			if (res == "Success") {
        	 			window.location.href = './Cancel_Member';
        	 			alert("Cancel Member Save Successfully");
        	 			} else {
        	 				alert("Cancel Member Save failed");
            ...
            function search_cancel_members() {
            	var accountnumber = document.getElementById("accountnumber").value;
