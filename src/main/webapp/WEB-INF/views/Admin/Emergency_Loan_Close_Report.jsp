    ...
    <body class="fixed-nav sticky-footer bg-dark" id="page-top">
        ...
        <%@ include
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <i class="fa fa-table"></i> Emergency Loan Close Report</div>
                        <div class="card-body" align="center">
                            ...
                            <form  action="#" autocomplete="on" method="post" enctype="multipart/form-data">
								...
								<button type="button" class="btn btn-primary" onclick="return loan_report();">Report</button>
                            </form>
            ...
            function loan_report() {
        	 ...
        	 //	var sdate1 = changeDateFormat(sdate);
        	 	var edate1 = document.getElementById("edate").value;
        	 //	var edate1 = changeDateFormat(edate);
        	 ...
        	 if (sdate1 == "") {
        	 	...
        	 	$.ajax({
        	 		type : "POST",
        			url : "./emergency_loan_close_report",
        			...
        			timeout : 600000,
        	 		...
        	 		success : function(data) {
        	 			...
        	 			var res = data;
        	 			if (res == "Success") {
        	 				window.open('./Emergency_Loan_Close_Report_Print', '_blank');
        	 		//	alert("Loan Apply Successfully");
        	 			} else {
        	 				alert("EmergencyLoan_Close_Report_Print Failed");        	 				
        	 			} 
        	 		}
        	 	});               	
                }          
