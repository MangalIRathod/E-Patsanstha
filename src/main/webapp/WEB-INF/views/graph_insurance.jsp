...
<html xmlns="https://www.thymeleafe.org">
    ...
    <head>
        ...
        <title>E-Patsanstha - Monthly Insurance</title>
        <!-- Bootstrap core CSS-->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <i class="fa fa-table"></i> Monthly Insurance Chart</div>
                        <div class="card-body" align="center">

						<div align="center">
        <h2>Month Wise Insurance Deposit Data</h2>
    </div>
    ...
    <script type="text/javascript">
        ...
        function drawChart(year, viewCounts) {
            Highcharts.chart('container-bar', {
                ...
                title : {
                    text : 'Month Wise Total Insurance Amount'
                },
                xAxis : [ {
                    title : {
                        text : 'Year'
