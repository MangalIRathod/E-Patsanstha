...
<html lang="en">
    ...
    <head>
        ...
        <title>E-Patsanstha - Insurance</title>
        <!-- Bootstrap core CSS-->
                        ...
                        <div class="card-body" align="center">
                            ...
                            <form  action="#" autocomplete="on" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="col">
                                        <input class="form-control" type="number" name="fdamount" value="${TotalInsuranceAmount}" required="required">
                                    </div>
                                </div>
                  <!--  
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control" type="text" name="fdamount" value="${Date}" required="required">
                                    </div>
                                </div>
                                
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-4 col-form-label">Monthly Deduction</label>
                                    <div class="col-8">
                                        <input class="form-control" type="number" name="fdamount" value="${InsuranceAmount}" required="required">
                                    </div>
                                </div>
                    ...
                    <div class="card mb-3">
						...
						<tbody>
                        <c:forEach var="obj" items="${InsuranceData}" varStatus="theCount">
                          	<tr>
