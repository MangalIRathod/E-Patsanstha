...
<html lang="en">
    ...
    <head>
        ...
        <title>E-Patsanstha - Share</title>
        <!-- Bootstrap core CSS-->
                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <i class="fa fa-table"></i> Share Form</div>
                        <div class="card-body" align="center">
                            ...
                            <form  action="#" autocomplete="on" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group ">
                                    <label for="example-text-input" class=" col-form-label">Total Share Amount</label>
                                    <div class="col">
                                        <input class="form-control" type="number" name="fdamount" value="${TotalAmountOfSahre}" required="required">
                                    </div>
                                </div>
<!--  
                                <div class="form-group row">
                                    ...
                                    <div class="col-8">
                                        <input class="form-control" type="text" name="fddate" value="${Date}" required="required">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="example-text-input" class="col-4 col-form-label">Monthly Deduct Amount</label>
                                    <div class="col-8">
                                        <input class="form-control" type="number" name="fdamount"value="" required="required">
                                    </div>
                                </div>
-->
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <i class="fa fa-table"></i> Share</div>
                        ...
                        <c:forEach var="obj" items="${ShareData}" varStatus="theCount">
                          <tr>
                            <td>${theCount.index+1}</td>
                        		...
                        		<td>${obj.fullname}</td>
                        		<td>${obj.date}</td>
                        		<td>${obj.shareallot}</td>
                        		<td>${obj.totalamountofshare}</td>
